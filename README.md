...
Der Benutzer soll in der Lage sein, mithilfe der Kamera des jeweiligen Endgeräts (z.B. Smartphone, Laptop), ein Bild von dem gewünschten Kassenbeleg zu machen und diesen für die Weiterverarbeitung in den lokalen Speicher des Browsers zu persistieren. Das Bild kann dabei jederzeit geändert oder gelöscht werden. Für das Erfassen des Dokuments wird das Plugin *Camera* von *Capacitor* verwendet: https://capacitorjs.com/docs/apis/camera
